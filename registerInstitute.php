        ...
        <div class="container mt-3">
                <div class="row">
                        <div class="col-5 mx-auto">
                                ...
                                <div class="card">
                                        <div class="card-header">Register Here For as Institues</div>
                                        <div class="card-body">
                                                <form action="" method="post">
                                                        ...
                                                        <div class="mb-2">
                                                                <div class="form-floating">
                                                                        <input type="text" placeholder="Esatblish Year" name="est_year" class="form-control">
                                                ...
                                                if (isset($_POST['create'])) {
                                                        ...
                                                        $type = 1;
                                                        $query = mysqli_query($connect, "insert into accounts (name,email,contact,password,est_year,board_name,type) value ('$name','$email','$contact','$password',
                                                       '$est_year','$board_name','$type')");
                                                        if ($query) {
                                                                redirect('login');
                                                        }
                                                }
