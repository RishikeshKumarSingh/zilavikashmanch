        ...
        <div class="container-fluid p-0">
                <div class="row g-0">
                        ...
                        <div class="col-10 p-4">
                                <div class="row">
                                        <div class="col-12">
                                                <h1 class="h5 fs-bolder">Manage Institude/College/University/School</h1>
                                        </div>
                                </div>
                        <table class="table mt-3">
                                ...
                                <?php
                                $callingInstitue= mysqli_query($connect,"select* from accounts where type='1'");
                                while($row=mysqli_fetch_array($callingInstitue)){
                                ?>
                                <tr>
                                        <!--demo line-->
                                        <td><?=$row['id'];?></td>
