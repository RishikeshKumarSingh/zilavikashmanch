        ...
        <div class="container-fluid p-0">
                <div class="row">
                        ...
                        <div class="col-10 px-5">
                                ...
                                <div class="row">
                                        <div class="col-8">
                                                <h1 class="h5 fs-bolder">Insert Project/Problems</h1></div>
                                        <div class="col-4">
                                ...
                                <div class="row">
                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                        <form action="" method="post">
                                                                                                                ...
                                                                                                                <div class="mb-3">
                                                                                                                        ...
                                                                                                                        <textarea name="cat_description" id="" cols="" rows="3" class="form-control"></textarea>
                                                                                                                </div>
                                                                                                                <div class="mb-3">
                                        ...
                                        if(isset($_POST['insertProject'])){
                                                ...
                                                if($_FILES['support_file'] != ""){
                                                        ...
                                                        move_uploaded_file($tmp_file,"../image/project/file/$file");
                                                }
                                                ...
                                                $query = mysqli_query($connect,"insert into projects (pro_title,category_id,description,address,image,status,admin_id,support_file)
                                                value ('$pro_title','$category_id','$description','$address','$image','$status','$admin_id','$file')");
