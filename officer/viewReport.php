        ...
        <div class="container-fluid p-0">
                <div class="row g-0">
                        ...
                        <div class="col-10 p-4">
                                <div class="row">
                                        <div class="col-8">
                                                <h1 class="h5 fs-bolder">View Report</h1>
                                        </div>
                                ...
                                <?php
                                $id = $_GET['rep_id'];
                                $callingProjects = mysqli_query($connect, "select * from reports JOIN accounts ON reports.account_id = accounts.id JOIN projects ON
                                 reports.project_id=projects.pro_id where r_id='$id'");
