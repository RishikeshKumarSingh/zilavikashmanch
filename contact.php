                         ...
                         <div class="card">
                                 <div class="card-body">
                                         ...
                                         <form action="" method="post">
                                                 ...
                                                 <div class="mb-3">
                                                         <label for="">Contacts <span class="text-danger">*</span></label>
                                                         <input type="text" name="contacts" class="form-control">
                                                 </div>
                                                 <div class="mb-3">
                                                         <label for="">Massage <span class="text-danger">*</span></label>
                                                         <textarea name="msg" id="" cols="" rows="10" class="form control"></textarea>
                                                 </div>
                                                 <div class="mb-3">
